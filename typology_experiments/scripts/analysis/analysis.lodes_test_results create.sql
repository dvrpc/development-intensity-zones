drop view if exists analysis.lodes_test_results;

create view analysis.lodes_test_results as 
with 
	density_and_accessibility_table as (select * from analysis.lodes_density_and_accessibility),
	...
	lodes_test_results_density_level_column as (
	...
	block_groups_dvrpc_2020_with_density_level_column as (
        ...
        from block_groups_dvrpc_2020_shp b
        	left join lodes_test_results_density_level_column d
            on b.block_group20 = d.block_group20
    	),
	lodes_test_results_accessibility_level_column as (
	...
	block_groups_dvrpc_2020_with_accessibility_level_column_too as (
        ...
        from block_groups_dvrpc_2020_with_density_level_column b
        	left join lodes_test_results_accessibility_level_column d
            on b.block_group20 = d.block_group20
    	),
    lodes_test_results_before_unique_id as (
        select
            b.block_group20,
            b.density,
            b.accessibility,
    ...
    select row_number() over() as row_number, block_group20, density, accessibility, density_level, accessibility_level, area_type, geom from lodes_test_results_before_unique_id