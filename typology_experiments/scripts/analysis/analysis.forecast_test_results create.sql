...
with 
	...
	forecast_test_results_density_level_column as (
		...
		select block_group20, density, accessibility, density_2050, accessibility_2050, 'very high' as density_level from density_and_accessibility_table where density >= (select density_thresholds from thresholds where levels = 'very high') union
    ...
    block_groups_dvrpc_2020_with_density_level_2050_column_too as (
        ...
        from block_groups_dvrpc_2020_with_accessibility_level_column_too b
        	left join forecast_test_results_density_level_2050_column d
            on b.block_group20 = d.block_group20
    	),
    ...
    block_groups_dvrpc_2020_with_accessibility_level_2050_column_too as (
        ...
        from block_groups_dvrpc_2020_with_density_level_2050_column_too b
        	left join forecast_test_results_accessibility_level_2050_column d
            on b.block_group20 = d.block_group20
    	),
    ...
    select row_number() over() as row_number, block_group20, density, accessibility, density_level, accessibility_level, area_type, density_2050, accessibility_2050, density_level_2050, accessibility_level_2050, area_type_2050, geom from forecast_test_results_before_unique_id