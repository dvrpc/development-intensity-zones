...
with /*The rest of this script from here on down was created by Sean Lawrence, I just wrote the 2 lines above and more indented most of the lines below*/
	a as (
		select
			bg."GEOID",
			bg.buff_mi, 
	...
	b as (
		...
		from
			a
		join analysis.bones_test_results bda on
