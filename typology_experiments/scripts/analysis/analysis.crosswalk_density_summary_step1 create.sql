drop view if exists analysis.crosswalk_density_summary_step1;

create view analysis.crosswalk_density_summary_step1 as 
with 
	bones_test_results_step1 as (select area_type, crosswalk_non_pos_water_density from analysis.bones_test_results_step1),
	crosswalk_density_summary_step1 as (
    ...
    select * from crosswalk_density_summary_step1
