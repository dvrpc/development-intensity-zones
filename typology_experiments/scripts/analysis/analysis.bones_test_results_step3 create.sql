drop view if exists analysis.bones_test_results_step3;

create view analysis.bones_test_results_step3 as 
with 
	...
	bones_test_results_step3_density_level_column as (
	...
	block_groups_24co_2020_with_density_level_column as (
        ...
        from block_groups_24co_2020_shp b
        	left join bones_test_results_step3_density_level_column d
            on b.block_group20 = d.block_group20
    	),
	bones_test_results_step3_accessibility_level_column as (
	...
	block_groups_24co_2020_with_accessibility_level_column_too as (
        ...
        from block_groups_24co_2020_with_density_level_column b
        	left join bones_test_results_step3_accessibility_level_column d
            on b.block_group20 = d.block_group20
    	),
