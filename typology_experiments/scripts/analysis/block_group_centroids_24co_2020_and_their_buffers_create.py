"""
This script creates analysis.block_group_centroids_24co_2020 and analysis.block_group_centroid_buffers_24co_2020
"""
...
block_group_centroids_24co_2020 = (
    block_groups_24co_2020.copy()
)  # Begins the process of getting the block groups' centroids

block_group_centroids_24co_2020["geom"] = block_group_centroids_24co_2020[
    "geom"
].centroid  # Finishes the process of getting the block groups' centroids


block_group_centroids_24co_2020_buffers_2_mile = (
    block_group_centroids_24co_2020.copy()
)  # Begins the process of getting all the block group centroids' 2 mile buffers

block_group_centroids_24co_2020_buffers_2_mile[
    "geom"
] = block_group_centroids_24co_2020_buffers_2_mile["geom"].buffer(
    3218.69
...
block_group_centroids_24co_2020_buffers_5_mile[
    "geom"
] = block_group_centroids_24co_2020_buffers_5_mile["geom"].buffer(
    8046.72
...
)  # Merges/row binds/etc block_group_centroids_24co_2020_buffers_2_mile and block_group_centroids_24co_2020_buffers_5_mile to get block_group_centroid_buffers_24co_2020


shps_to_upload_dictionary = {
    "block_group_centroids_24co_2020": block_group_centroids_24co_2020,
    "block_group_centroid_buffers_24co_2020": block_group_centroid_buffers_24co_2020,
